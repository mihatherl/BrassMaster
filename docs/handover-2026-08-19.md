...
> **Superseded by `handover.md`**, which covers 2026-08-20/21 and the corpus
> work. This file is kept for the product decisions it records — the free/paid
> split, the fork from the legacy app, the App Store plan — which still stand.
> Its figures (v2.25.0, 1,080 tests) are stale.
